...
CREATE TABLE `talles` (
  ...
  KEY `talles_ibfk_1` (`ID_Producto`),
  CONSTRAINT `talles_ibfk_1` FOREIGN KEY (`ID_Producto`) REFERENCES `productos` (`ID_Producto`) ON DELETE CASCADE
...
INSERT INTO `talles` VALUES (17,13,'36'),(18,14,'36');
